...
import com.example.hello.activity.DetailActivity
import com.example.hello.databinding.ViewholderRecommendedBinding
...
RecyclerView.Adapter<PopularAdapter.ViewHolder>(){
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.binding.priceTag.text="₹"+items[position].price.toString()
